    ...
    <div className="flex flex-col h-full bg-black border-r border-neutral-800 w-64 text-neutral-300 select-none">
      ...
      <div className="p-5 border-b border-neutral-800 flex items-center justify-between">
        <Link href="/dashboard" className="flex items-center space-x-3 group">
          ...
          <div>
            <h1 className="font-extrabold text-white tracking-tight leading-none text-lg">
              AI Return <span className="text-indigo-400">IQ</span>
            </h1>
            <span className="text-xs text-neutral-400 font-semibold">E-commerce Intelligence</span>
          </div>
        </Link>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-2 overflow-y-auto">
        <div className="px-3 pb-2 text-xs font-bold text-neutral-400 uppercase tracking-wider">
          Main Navigation
        </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center justify-between px-4 py-3 rounded-xl font-bold text-base transition-all duration-200 ${
                isActive
      ...
      <div className="p-4 border-t border-neutral-800">
        <div className="p-4 rounded-xl bg-neutral-900/90 border border-neutral-800 flex flex-col space-y-2">
