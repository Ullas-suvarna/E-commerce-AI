      ...
      <div className="bg-white border border-slate-200 rounded-3xl max-w-xl w-full overflow-hidden shadow-2xl animate-fade-in flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-b border-slate-200 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-bold text-lg text-slate-900">Edit Return Record</h3>
              <p className="text-xs text-slate-500">Update record attributes in Cloud Firestore ({record.id})</p>
            </div>
          </div>
